...
*/
const int direct = 7; // Grey  wire to stepper controller DIR
const int pulse = 4; // White wire to stepper controller PUL
const int led13 = 13;
...
int ramp = 0;
int ramp_delay = 0;
int stroke_time = 352; // Stroke time = 0.833248 seconds
  ...
  count = 1;
   digitalWrite(direct, HIGH);
    do { 
        ...
        delayMicroseconds(2500);            // wait for a 5m seconds
